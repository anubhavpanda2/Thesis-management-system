...
/*	$que="INSERT into stud1 values('caman','ca','student')";
   ...
   echo "failed";*/
	$query = mysql_query("SELECT * FROM reviewer1, stud2 where  stud2.roll=reviewer1.roll and stud2.roll='$roll'");
	echo"<table>";
	echo "<tr>";
	echo "<td>REVIEWER'SNAME</TD>";
	echo "<td>AREA OF INTEREST</TD>";
	echo "<td>TOPIC'SNAME</TD>";
...
<form action="reviewers.php?id=<?php echo $roll?>" method="post">

<input type='submit' name='submit' value='submit' />
</form>
<form action="dean4.php?id=<?php echo $roll?>" method="post">
